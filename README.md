<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/575405602/25.1.3%2B)
...
![Blazor DxCharts update the data source](/charts.png)
